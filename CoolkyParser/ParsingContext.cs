...
namespace CoolkyRecipeParser
{
    public abstract class ParsingContext
    {
        ...
        public virtual List<string> GetIngredients(IParsingLogic logic, IDocument page) => logic.GetIngredients(page);
        public virtual List<string> GetSteps(IParsingLogic logic, IDocument page) => logic.GetSteps(page);
    }
}
